<div class="xl:px-64">
    <div class="relative font-semibold xl:text-xl mb-10">
        <p class="relative mx-auto w-fit text-2xl text-black-primary dark:text-white md:text-4xl">
    ...
    <div class="flex flex-row flex-wrap justify-center gap-10 2xl:justify-start">
        <!-- GitHub -->
        <a class="flex h-16 w-52 cursor-pointer items-center gap-5 rounded-xl border-2 border-black-primary bg-white p-3 text-black-primary shadow-button-card transition-all duration-200 hover:scale-105 hover:shadow-image-card" href="https://github.com/">
        ...
        <!-- Instagram -->
        <a class="flex h-16 w-52 cursor-pointer items-center gap-5 rounded-xl border-2 border-black-primary bg-white p-3 text-black-primary shadow-button-card transition-all duration-200 hover:scale-105 hover:shadow-image-card" href="https://www.instagram.com/">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
                <g fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
       ...
       <!-- LinkedIn -->
       <a class="flex h-16 w-52 cursor-pointer items-center gap-5 rounded-xl border-2 border-black-primary bg-white p-3 text-black-primary shadow-button-card transition-all duration-200 hover:scale-105 hover:shadow-image-card" href="https://www.linkedin.com/">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
    ...
    <!-- Gmail -->
    <a class="flex h-16 w-52 cursor-pointer items-center gap-5 rounded-xl border-2 border-black-primary bg-white p-3 text-black-primary shadow-button-card transition-all duration-200 hover:scale-105 hover:shadow-image-card" href="mailto:example@example.com">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
